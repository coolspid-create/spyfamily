                    ...
                    {currentFamilyId ? (
                        ...
                        <div className="space-y-5">
                            ...
                            <button
                                type="button"
                                onClick={handleSignOut}
                                className="flex w-full items-center justify-center gap-2 rounded-xl border border-navy/10 bg-navy/5 py-3 text-[13px] font-black text-navy transition-colors hover:bg-navy/10"
                            >
                                <LogOut size={15} /> 로그아웃
                            </button>
                        </div>
                        ...
                        <button
                            ...
                            className="mt-5 w-full text-center text-[11px] font-bold text-navy/40 underline underline-offset-2 transition-colors hover:text-accent-red"
                        >
